...
namespace Calculator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            using (CalcClient proxy = new CalcClient())
            {
                if (operation != Operation.None)
                {
                    ...
                    {
                        case Operation.Add:
                            result = proxy.Add(operand, operand2);
                            break;
                        case Operation.Subtract:
                            result = proxy.Subtract(operand, operand2);
                            break;
                        case Operation.Multiply:
                            result = proxy.Multiply(operand, operand2);
                            break;
                        case Operation.Divide:
                            ...
                            result = proxy.Divide(operand, operand2);
                            break;
                    }
